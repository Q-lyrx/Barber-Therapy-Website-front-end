...
export default function HaircutBeardBooking() {
  useEffect(() => {
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center items-center gap-6 mb-4">
              ...
              <span className="text-brand-white text-lg font-semibold">
                <i className="fas fa-dollar-sign text-brand-gold mr-2"></i>$60
              </span>
            </div>
            <p className="text-lg text-brand-white/90 mb-6 max-w-xl mx-auto">
              Book your complete grooming appointment with precision haircut and beard trimming.
            </p>
          </div>
          ...
          <div className="bg-brand-black rounded-lg p-4 mb-8">
            <div
              ...
              data-url="https://calendly.com/mujahidlila313/haircut-beard-45?hide_gdpr_banner=1&background_color=1a1a1a&text_color=ffd700&primary_color=ffd700"
              data-resize="true"
              style={{
                minWidth: '320px',
                height: '700px',
