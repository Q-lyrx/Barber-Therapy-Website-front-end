...
export default function HaircutBeardBooking() {
  ...
  useEffect(() => {
    const calendlyUrl = 'https://calendly.com/mujahidlila313/haircut-beard-45?hide_gdpr_banner=1&background_color=1a1a1a&text_color=ffd700&primary_color=ffd700';
