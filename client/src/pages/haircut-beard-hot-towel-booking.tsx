...
export default function HaircutBeardHotTowelBooking() {
  const containerRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    const calendlyUrl = 'https://calendly.com/mujahidlila313/haircut-beard-hot-towel-50?hide_gdpr_banner=1&background_color=1a1a1a&text_color=ffd700&primary_color=ffd700';
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-brand-gold mb-4">
              Haircut + Beard and Hot Towel Service
            </h1>
            <div className="flex justify-center items-center gap-6 mb-4">
              <span className="text-brand-white text-lg font-semibold">
                <i className="fas fa-clock text-brand-gold mr-2"></i>1 hour
              </span>
              <span className="text-brand-white text-lg font-semibold">
                <i className="fas fa-dollar-sign text-brand-gold mr-2"></i>$55
              </span>
            </div>
            <p className="text-lg text-brand-white/90 mb-6 max-w-xl mx-auto">
              Book your premium service with soothing hot towel treatment.
            </p>
          </div>
