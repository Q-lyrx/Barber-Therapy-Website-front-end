...
export default function FullServiceBooking() {
  const containerRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    const calendlyUrl = 'https://calendly.com/mujahidlila313/full-service?hide_gdpr_banner=1&background_color=1a1a1a&text_color=ffd700&primary_color=ffd700';
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center items-center gap-6 mb-4">
              <span className="text-brand-white text-lg font-semibold">
                <i className="fas fa-clock text-brand-gold mr-2"></i>1.5 hours
              </span>
              <span className="text-brand-white text-lg font-semibold">
                <i className="fas fa-dollar-sign text-brand-gold mr-2"></i>$80
              </span>
            </div>
            <p className="text-lg text-brand-white/90 mb-6 max-w-xl mx-auto">
              Book your complete luxury experience with all premium services.
            </p>
          </div>
