...
export default function CustomPackageBooking() {
  ...
  useEffect(() => {
    const calendlyUrl = 'https://calendly.com/mujahidlila313/customize-your-own-package?hide_gdpr_banner=1&background_color=1a1a1a&text_color=ffd700&primary_color=ffd700';
