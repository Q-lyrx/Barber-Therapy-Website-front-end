...
export default function TagTeamPackageBooking() {
  const containerRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    const calendlyUrl = 'https://calendly.com/mujahidlila313/tag-team-package-160?hide_gdpr_banner=1&background_color=1a1a1a&text_color=ffd700&primary_color=ffd700';
