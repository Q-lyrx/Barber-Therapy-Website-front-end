...
export default function UltimatePackageBooking() {
  const containerRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    const calendlyUrl = 'https://calendly.com/mujahidlila313/the-ultimate-package?hide_gdpr_banner=1&background_color=1a1a1a&text_color=ffd700&primary_color=ffd700';
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-brand-white/90 mb-6 max-w-xl mx-auto">
              Book your Ultimate Package and save $20 on premium services.
            </p>
          </div>
