  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-7xl mx-auto px-3 sm:px-6">
        ...
        <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[8rem] 2xl:text-[9rem] font-bold mb-6 sm:mb-8 lg:mb-10 xl:mb-12 leading-[0.85] animate-fade-in-up drop-shadow-2xl">
