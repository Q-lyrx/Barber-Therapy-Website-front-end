  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6">
        <div className="inline-block rounded-xl sm:rounded-2xl bg-black/35 backdrop-blur-[2px] px-4 py-4 sm:px-6 sm:py-6 md:px-10 md:py-8 shadow-2xl ring-1 ring-white/5 max-w-[90vw] sm:max-w-none">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 sm:mb-6 leading-tight animate-fade-in-up drop-shadow-2xl">
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-brand-white/95 mb-6 sm:mb-8 font-light leading-relaxed animate-fade-in-up drop-shadow-lg">
          A space where you can transform both your look and your mindset all at once. It is more than just a haircut.
        </p>
        <div className="flex justify-center animate-fade-in-up">
          <Button 
            onClick={scrollToServices}
            className="bg-brand-gold text-brand-black hover:bg-brand-dark-gold transition-all duration-300 transform hover:scale-105 px-4 py-3 sm:px-6 sm:py-3 md:px-8 md:py-4 text-sm sm:text-base md:text-lg font-semibold"
          >
